...
public class Listeners extends Base implements ITestListener { // ITestListener interface :listener for test running.
	...
	public void onTestStart(ITestResult result) {// executes before each test execution.
